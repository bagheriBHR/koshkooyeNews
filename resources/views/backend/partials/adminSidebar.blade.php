<div class="sidebar col-12 col-md-5 pr-md-0">
            ...
            <table class="w-100 text-right">
                ...
                @can('update',\Illuminate\Support\Facades\Auth::user())
                    <tr>
                        ...
                        <td class="d-flex justify-content-end py-2 font-weight-normal pl-3">
                            <a class="d-flex align-items-center" href="{{route('comment.index')}}"><i class="fas fa-eye ml-2"></i> مشاهده</a>
                        </td>
                    </tr>
                @endcan
            </table>
    ...
    <div class="collapse show" id="collapseExample4">
        <div class="card card-body mb-4 border-0 p-0">
            <table class="w-100 text-right">
                <tr>
                    <td class="py-2 pr-2 font-weight-bold"><i class="fas fa-envelope  ml-2"></i>تماس ها </td>
                    <td class="d-flex justify-content-end py-2 font-weight-normal pl-3">
                        <a class="d-flex align-items-center" href="{{route('contact.index')}}"><i class="fas fa-eye ml-2"></i> مشاهده</a>
                    </td>
                </tr>
            </table>
        </div>
