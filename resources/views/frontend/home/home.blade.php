...
{{--    @if(!($photoArticles->isEmpty()) && !($videoArticles->isEmpty()))--}}
        <div class="image-card d-flex flex-column py-3 px-2 px-md-5 mt-3">
            <div class="multimedia d-flex flex-column flex-md-row">
                <div class="col-12 col-md-6 d-flex flex-column flex-md-row pt-3 pt-md-0 px-0">
                ...
                <div class="col-12 col-md-6 d-flex flex-column justify-content-between videoSection pr-md-3 mr-md-3 pl-md-0 custom-border-right mt-3 mt-md-0">
