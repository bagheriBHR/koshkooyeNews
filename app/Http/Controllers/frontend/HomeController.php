...
class HomeController extends Controller
{
    public function index(Request $request)
    {
        ...
        $sliders = Article::with(['categories'=>function($q){
            ...
            ->where('publish_status',1)->where('type',0)->orderBy('created_at','desc')->limit(10)->get();
        ...
        $photoArticles = Article::where('publish_status',1)->where('type',1)->orderBy('created_at','desc')->limit(4)->get();
        $videoArticles = Article::where('publish_status',1)->where('type',2)->orderBy('created_at','desc')->limit(5)->get();
        ...
        return view('frontend.home.home',compact(['sliders','categories','photoArticles','videoArticles','activeCommercials']));
    }
